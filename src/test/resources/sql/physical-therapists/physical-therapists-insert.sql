...
insert into physical_therapists (id, name, cpf, id_user) values (1, 'Ana maria', '10931320003', 100);
insert into physical_therapists (id, name, cpf, id_user) values (2, 'Maria Silva', '27343573055', 101);
insert into physical_therapists (id, name, cpf, id_user) values (3, 'Joaquina Silva', '81858590000', 102);
insert into physical_therapists (id, name, cpf, id_user) values (4, 'Eduardo Silva', '71288012004', 103);
insert into physical_therapists (id, name, cpf, id_user) values (5, 'Jose Silva', '69001332072', 104);
insert into physical_therapists (id, name, cpf, id_user) values (6, 'Ezequiel Silva', '81397964090', 105);
insert into physical_therapists (id, name, cpf, id_user) values (7, 'Ramos Silva', '33213557013', 106);
insert into physical_therapists (id, name, cpf, id_user) values (8, 'Carlos Silva', '25228094075', 107);